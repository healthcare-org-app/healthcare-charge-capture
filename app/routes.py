"""HTTP routes for charge-capture-service.

Generic CRUD over the `charge_capture` table. Every mutating endpoint publishes a
domain event (charge.captured) and an audit event; reads publish audit only.
...
RESOURCE = "charge_capture"
CREATED_EVENT = "charge.captured"
UPDATED_EVENT = ""
